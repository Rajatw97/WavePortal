  ...
  return (
    <div className="mainContainer">
      ...
      <div className="dataContainer">
        ...
        <div className="bio">
        I am Rajat and i am learning Web3.0 ? Connect your Ethereum wallet and wave at me!
        </div>
      
        <input type="text" id="input" value={msg} onChange={ e => setMsg(e.target.value)}/>
        ...
        {allWaves.map((wave, index) => {
          return (
            <div key={index} style={{ backgroundColor: "lightBlue", marginTop: "16px", padding: "8px", border: "solid grey" }}>
